...
public class Class13MathScoreMaxWorker {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 2、设置class
        job.setJarByClass(Class13MathScoreMaxWorker.class);
    ...
    static  class  MyMapper extends Mapper<LongWritable, Text, IntWritable, Text> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (subject.equals("math")&&classz.equals("13")) {
    ...
    static class  MyReducer extends Reducer<IntWritable,Text, Text,IntWritable> {
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            context.write(new Text("13classMathMaxScore"),new IntWritable(maxScore));
        }
    }
}
